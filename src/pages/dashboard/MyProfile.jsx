...
const MyProfile = () => {
  ...
  return (
    ...
    <div className="flex justify-center items-start min-h-screen bg-base-200 p-0 md:p-8">


      {/* card bg-base-100 ensures the card background respects the theme */}
      <div className="w-full max-w-4xl card bg-base-100 shadow-xl border border-base-300">

        {/* Profile Content Grid */}
        <div className="grid grid-cols-1 md:grid-cols-3">
          {/* Header / Left Column */}
          <div className="relative p-6 border-b md:border-b-0 md:border-r border-base-200 flex flex-col items-center bg-primary/5 md:col-span-1">
            ...
            <div className="relative group mb-4">
              <img
                ...
                className="w-32 h-32 rounded-full object-cover border-4 border-primary shadow-xl shadow-primary/30 transition-all duration-300"
              />
            </div>
            ...
            {isEditing && (
              <div className="w-full mt-4">
                ...
                <label htmlFor="imageUrl" className="block text-xs font-semibold text-base-content opacity-90 mb-1 text-left">
                  Profile Image URL
                </label>
                <input
                  type="url"
          ...
          <div className="p-6 md:col-span-2">
            ...
            <h3 className="text-xl font-semibold text-primary mb-6 pb-2 border-b border-base-200">
              Account Information
            </h3>
            <div className="space-y-4">
              ...
              <LightDisplayField label="Email Status" value={user?.emailVerified ? "Verified" : "Not Verified"} />
              <LightDisplayField label="Last Login" value={user?.metadata?.lastSignInTime ? formatDate(user.metadata.lastSignInTime) : "N/A"} />
            </div>
          </div>
        </div>
